...
const products = [
  ...
  },
  {
    ...
    badge: "新品",
    price: "内测免费中",
    tagline: "智能剪辑，基于AI的智能剪辑系统，提供个性化剪辑方案",
    points: ["AI剪辑", "字幕提取", "视频总结", "高光识别"],
  ...
  },
  {
    ...
    tagline: "智能弹幕互动、LLM智能决策、拟人化发送、熔断保护、浏览器自动化",
    points: ["智能弹幕互动：根据弹幕内容智能回复", "LLM智能决策：根据弹幕内容智能决策", "拟人化发送：拟人化发送弹幕", "熔断保护：熔断保护，防止机器人被封禁", "浏览器自动化：浏览器自动化，防止机器人被封禁"],
    link: "https://space.bilibili.com/3709626",
    video: "https://www.bilibili.com/video/BV1q4NTz1EQ5",
    deployLink: null,
    docLink: null,
    gradient: "from-cyan-500/60 via-teal-500/60 to-emerald-500/60",
    image: "/img/直播间智能互动助手.png",
  },
  {
    id: "travel",
    name: "洛曦云旅",
